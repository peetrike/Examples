function New-IsoFile {
    <#
        ...
        .Example
            ...
            c:\tools and c:\downloads\utils folders.
        ...
        .Example
            ...
            https://docs.microsoft.com/windows/win32/api/imapi2/ne-imapi2-imapi_media_physical_type
        .Notes
            NAME: New-IsoFile
            AUTHOR: Chris Wu
    ...
    Param (
        ...
        $Source,
            ...
            [string]
        $Path = "$env:temp\$((Get-Date).ToString('yyyyMMdd-HHmmss.ffff')).iso",
        ...
        $Media = 'DVDPLUSRW_DUALLAYER',
            [string]
        $Title = (Get-Date).ToString("yyyyMMdd-HHmmss.ffff"),
            [switch]
        $Force
    )
...
'@
        ...
        ).ChooseImageDefaultsForMediaType($MediaType.IndexOf($Media))
