...
"@
            ...
            $dynParam1 = New-Object -TypeName System.Management.Automation.RuntimeDefinedParameter('ProgressStyle', [string], $attributeCollection)
    ...
    Begin {
        ...
        $loadingMessage = $loading | Get-Random
